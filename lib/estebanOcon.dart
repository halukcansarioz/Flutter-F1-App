...
class EstebanOcon extends StatefulWidget {
  const EstebanOcon({Key? key}) : super(key: key);

  @override
  State<EstebanOcon> createState() => _EstebanOconState();
}

class _EstebanOconState extends State<EstebanOcon> {
  String _htmlVeri = '';
  ...
  Future _istek() async {
    ...
    setState(() {});
    var url = Uri.https(
        'www.formula1.com', '/en/drivers/esteban-ocon.html', {'q': '{http}'});
  ...
  int _current = 0;
  List imgList = [
    "assets/images/EstebanOCON2.jpg",
    "assets/images/EstebanOCON3.jpg",
    "assets/images/EstebanOCON4.jpg",
    "assets/images/EstebanOCON5.jpg",
    "assets/images/EstebanOCON6.jpg",
  ];
