...
class _FerrariState extends State<Ferrari> {
  ...
  Future _istek() async {
    ...
    setState(() {});
    var url = Uri.https(
        'www.formula1.com', '/en/teams/Ferrari.html', {'q': '{http}'});
  ...
  int _current = 0;
  List imgList = [
    "assets/images/Ferrari1.jpg",
    "assets/images/Ferrari2.jpg",
    "assets/images/Ferrari3.jpg",
    "assets/images/Ferrari4.jpg",
    "assets/images/Ferrari5.jpg",
    "assets/images/Ferrari6.jpg",
  ];
