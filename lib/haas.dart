...
class Haas extends StatefulWidget {
  const Haas({Key? key}) : super(key: key);

  @override
  State<Haas> createState() => _HaasState();
}
...
class _HaasState extends State<Haas> {
  ...
  Future _istek() async {
    ...
    setState(() {});
    var url =
        Uri.https('www.formula1.com', '/en/teams/Haas.html', {'q': '{http}'});
  ...
  int _current = 0;
  List imgList = [
    "assets/images/Haas1.jpg",
    "assets/images/Haas2.jpg",
    "assets/images/Haas3.jpg",
    "assets/images/Haas4.jpg"
  ];
