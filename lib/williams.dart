...
class Williams extends StatefulWidget {
  const Williams({Key? key}) : super(key: key);

  @override
  State<Williams> createState() => _WilliamsState();
}
...
class _WilliamsState extends State<Williams> {
  ...
  Future _istek() async {
    ...
    setState(() {});
    var url = Uri.https(
        'www.formula1.com', '/en/teams/Williams.html', {'q': '{http}'});
  ...
  int _current = 0;
  List imgList = [
    "assets/images/Williams1.jpg",
    "assets/images/Williams2.jpg",
    "assets/images/Williams3.jpg",
    "assets/images/Williams4.jpg",
    "assets/images/Williams5.jpg",
    "assets/images/Williams6.jpg",
  ];
