...
class KevinMagnussen extends StatefulWidget {
  const KevinMagnussen({Key? key}) : super(key: key);

  @override
  State<KevinMagnussen> createState() => _KevinMagnussenState();
}

class _KevinMagnussenState extends State<KevinMagnussen> {
  String _htmlVeri = '';
  ...
  Future _istek() async {
    _htmlVeri = '';
    setState(() {});
    var url = Uri.https('www.formula1.com', '/en/drivers/kevin-magnussen.html',
        {'q': '{http}'});
  ...
  int _current = 0;
  List imgList = [
    "assets/images/KevinMAGNUSSEN2.jpg",
    "assets/images/KevinMAGNUSSEN3.jpg",
    "assets/images/KevinMAGNUSSEN4.jpg",
  ];
