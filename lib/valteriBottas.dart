...
class ValteriBottas extends StatefulWidget {
  const ValteriBottas({Key? key}) : super(key: key);

  @override
  State<ValteriBottas> createState() => _ValteriBottasState();
}

class _ValteriBottasState extends State<ValteriBottas> {
  String _htmlVeri = '';
  ...
  Future _istek() async {
    _htmlVeri = '';
    setState(() {});
    var url = Uri.https('www.formula1.com', '/en/drivers/valtteri-bottas.html',
        {'q': '{http}'});
  ...
  int _current = 0;
  List imgList = [
    "assets/images/ValteriBottas2.jpg",
    "assets/images/ValteriBottas3.jpg",
    "assets/images/ValteriBottas4.jpg",
    "assets/images/ValteriBottas5.jpg",
  ];
