...
class LandoNorris extends StatefulWidget {
  const LandoNorris({Key? key}) : super(key: key);

  @override
  State<LandoNorris> createState() => _LandoNorrisState();
}

class _LandoNorrisState extends State<LandoNorris> {
  String _htmlVeri = '';
  ...
  Future _istek() async {
    ...
    setState(() {});
    var url = Uri.https(
        'www.formula1.com', '/en/drivers/lando-norris.html', {'q': '{http}'});
  ...
  int _current = 0;
  List imgList = [
    "assets/images/LandoNORRIS2.jpg",
    "assets/images/LandoNORRIS3.jpg",
    "assets/images/LandoNORRIS4.jpg",
    "assets/images/LandoNORRIS5.jpg",
    "assets/images/LandoNORRIS6.jpg",
  ];
