...
class AlfaRomeo extends StatefulWidget {
  const AlfaRomeo({Key? key}) : super(key: key);

  @override
  State<AlfaRomeo> createState() => _AlfaRomeoState();
}

class _AlfaRomeoState extends State<AlfaRomeo> {
  String _htmlVeri = '';
  ...
  Future _istek() async {
    _htmlVeri = '';
    setState(() {});
    var url = Uri.https('www.formula1.com', '/en/teams/Alfa-Romeo-Racing.html',
        {'q': '{http}'});
  ...
  int _current = 0;
  List imgList = [
    "assets/images/AlfaRomeo1.jpg",
    "assets/images/AlfaRomeo2.jpg",
    "assets/images/AlfaRomeo3.jpg",
    "assets/images/AlfaRomeo4.jpg",
    "assets/images/AlfaRomeo5.jpg",
    "assets/images/AlfaRomeo6.jpg",
  ];
