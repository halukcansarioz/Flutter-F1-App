...
class ZhouGuanyu extends StatefulWidget {
  const ZhouGuanyu({Key? key}) : super(key: key);

  @override
  State<ZhouGuanyu> createState() => _ZhouGuanyuState();
}

class _ZhouGuanyuState extends State<ZhouGuanyu> {
  String _htmlVeri = '';
  ...
  Future _istek() async {
    ...
    setState(() {});
    var url = Uri.https(
        'www.formula1.com', '/en/drivers/guanyu-zhou.html', {'q': '{http}'});
  ...
  int _current = 0;
  List imgList = [
    "assets/images/ZhouGuanyu2.jpg",
    "assets/images/ZhouGuanyu3.jpg",
    "assets/images/ZhouGuanyu4.jpg",
    "assets/images/ZhouGuanyu5.jpg",
  ];
