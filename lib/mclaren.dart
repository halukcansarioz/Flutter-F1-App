...
class McLaren extends StatefulWidget {
  const McLaren({Key? key}) : super(key: key);
...
class _McLarenState extends State<McLaren> {
  ...
  Future _istek() async {
    ...
    setState(() {});
    var url = Uri.https(
        'www.formula1.com', '/en/teams/McLaren.html', {'q': '{http}'});
  ...
  int _current = 0;
  List imgList = [
    "assets/images/McLaren1.jpg",
    "assets/images/McLaren2.jpg",
    "assets/images/McLaren3.jpg",
    "assets/images/McLaren4.jpg",
    "assets/images/McLaren5.jpg",
    "assets/images/McLaren6.jpg",
  ];
