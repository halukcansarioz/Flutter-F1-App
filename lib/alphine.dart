...
class Alphine extends StatefulWidget {
  const Alphine({Key? key}) : super(key: key);

  @override
  State<Alphine> createState() => _AlphineState();
}

class _AlphineState extends State<Alphine> {
  String _htmlVeri = '';
  ...
  Future _istek() async {
    ...
    setState(() {});
    var url =
        Uri.https('www.formula1.com', '/en/teams/Alpine.html', {'q': '{http}'});
  ...
  int _current = 0;
  List imgList = [
    "assets/images/Alphine1.jpg",
    "assets/images/Alphine2.jpg",
    "assets/images/Alphine3.jpg",
    "assets/images/Alphine4.jpg",
    "assets/images/Alphine5.jpg",
    "assets/images/Alphine6.jpg",
  ];
