...
class RedBull extends StatefulWidget {
  const RedBull({Key? key}) : super(key: key);
...
class _RedBullState extends State<RedBull> {
  ...
  Future _istek() async {
    ...
    setState(() {});
    var url = Uri.https(
        'www.formula1.com', '/en/teams/Red-Bull-Racing.html', {'q': '{http}'});
  ...
  int _current = 0;
  List imgList = [
    "assets/images/RedBull1.jpg",
    "assets/images/RedBull2.jpg",
    "assets/images/RedBull3.jpg",
    "assets/images/RedBull4.jpg",
    "assets/images/RedBull5.jpg",
    "assets/images/RedBull6.jpg",
  ];
