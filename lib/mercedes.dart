...
class Mercedes extends StatefulWidget {
  const Mercedes({Key? key}) : super(key: key);
...
class _MercedesState extends State<Mercedes> {
  ...
  Future _istek() async {
    ...
    setState(() {});
    var url = Uri.https(
        'www.formula1.com', '/en/teams/Mercedes.html', {'q': '{http}'});
  ...
  int _current = 0;
  List imgList = [
    "assets/images/1646932821739.jpg",
    "assets/images/1647002790264.jpg",
    "assets/images/1647085167162.jpg",
    "assets/images/1647087350662.jpg",
    "assets/images/1647090476768.jpg",
    "assets/images/1647091740679.jpg",
  ];
