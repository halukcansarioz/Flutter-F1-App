...
class YukiTsunoda extends StatefulWidget {
  const YukiTsunoda({Key? key}) : super(key: key);

  @override
  State<YukiTsunoda> createState() => _YukiTsunodaState();
}

class _YukiTsunodaState extends State<YukiTsunoda> {
  String _htmlVeri = '';
  ...
  Future _istek() async {
    ...
    setState(() {});
    var url = Uri.https(
        'www.formula1.com', '/en/drivers/yuki-tsunoda.html', {'q': '{http}'});
  ...
  int _current = 0;
  List imgList = [
    "assets/images/YukiTsunoda2.jpg",
    "assets/images/YukiTsunoda3.jpg",
    "assets/images/YukiTsunoda4.jpg",
    "assets/images/YukiTsunoda5.jpg",
    "assets/images/YukiTsunoda6.jpg",
  ];
