...
class AlphaTauri extends StatefulWidget {
  const AlphaTauri({Key? key}) : super(key: key);

  @override
  State<AlphaTauri> createState() => _AlphaTauriState();
}
...
class _AlphaTauriState extends State<AlphaTauri> {
  ...
  Future _istek() async {
    ...
    setState(() {});
    var url = Uri.https(
        'www.formula1.com', '/en/teams/AlphaTauri.html', {'q': '{http}'});
  ...
  int _current = 0;
  List imgList = [
    "assets/images/AlphaTauri6.jpg",
    "assets/images/AlphaTauri7.jpg",
    "assets/images/AlphaTauri2.jpg",
    "assets/images/AlphaTauri3.jpg",
    "assets/images/AlphaTauri4.jpg",
    "assets/images/AlphaTauri5.jpg",
  ];
