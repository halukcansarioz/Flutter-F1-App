...
class LanceStroll extends StatefulWidget {
  const LanceStroll({Key? key}) : super(key: key);

  @override
  State<LanceStroll> createState() => _LanceStrollState();
}

class _LanceStrollState extends State<LanceStroll> {
  String _htmlVeri = '';
  ...
  Future _istek() async {
    ...
    setState(() {});
    var url = Uri.https(
        'www.formula1.com', '/en/drivers/lance-stroll.html', {'q': '{http}'});
  ...
  int _current = 0;
  List imgList = [
    "assets/images/LanceSTROLL2.jpg",
    "assets/images/LanceSTROLL3.jpg",
    "assets/images/LanceSTROLL4.jpg",
    "assets/images/LanceSTROLL5.jpg",
  ];
